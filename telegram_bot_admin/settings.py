"""
Django settings for telegram_bot_admin project.
...
SECRET_KEY = 'django-insecure-u=u9xw88l09&$j0f2%m3yvpzyv5^p+-0*%^+#z8@&==)3*#vzm'
...
ROOT_URLCONF = 'telegram_bot_admin.urls'
...
WSGI_APPLICATION = 'telegram_bot_admin.wsgi.application'
...
JAZZMIN_SETTINGS = {
    "site_title": "2B-Cargo",  # Заголовок админ-панели
    "site_header": "2B-Cargo",  # Заголовок на экране входа
    "site_brand": "2B-Cargo",  # Бренд в верхней части админ-панели
    "welcome_sign": "Добро пожаловать в 2B-Cargo",  # Приветственное сообщение
    "site_title": "2B-Cargo",  # Заголовок админ-панели
    "site_header": "2B-Cargo",  # Заголовок на экране входа
    "site_brand": "2B-Cargo",  # Бренд в верхней части админ-панели
    "welcome_sign": "Добро пожаловать в 2B-Cargo",  # Приветственное сообщение
